...
// Author:         R. Lutter
// Revision:       $Id: TSnkDDACommon.h,v 1.1 2009-03-26 11:13:41 Rudolf.Lutter Exp $       
// Date:           
// URL:            
// Keywords:       
//////////////////////////////////////////////////////////////////////////////
...
enum ESnkServers		{	kSnkSrvOldDDA			=	BIT(0),
							kSnkSrvNewDDA			=	BIT(1)
						};
...
enum ESnkBeamOnOff		{	kSnkBeamOff				=	2055,
							kSnkBeamOn				=	3000
						};
...
const SMrbNamedX kSnkLofServers[] =
							{
								{kSnkSrvOldDDA,		"mamba",	"Server program DDAExec @ mamba"	},
								{kSnkSrvNewDDA,		"mamba2",	"Server program DDAExecME @ mamba2"	},
								{0, 				NULL,			NULL							}
							};
