...
#include "dda0816/include/dda0816_iomap.h"
...
TROOT root("DDAExecME","SNAKE Scanning (Meilhaus)", initfuncs);

int main(int argc, char **argv) {
//______________________________________________________________[MAIN PROGRAM]
//////////////////////////////////////////////////////////////////////////////
// Name:           DDAExecME
// Purpose:        Operate Meilhaus SylverFoxx 4680 card
//////////////////////////////////////////////////////////////////////////////
...
//			offlineMode = (eMode & kSnkEMOffline) != 0;
		...
		} else if (scanInProgress && (stopWatch.RealTime() >= stopAt)) {
			DDAStopScan();
			stopWatch.Stop();
			scanInProgress = kFALSE;
