...
static const Int_t NPPC = 15, MBSV = 2, TRIGS = 2;

static const Char_t * masters[] = {"ppc-0", "ppc-1", "ppc-2", "ppc-3", "ppc-4", "ppc-5", "ppc-6", "ppc-7", "ppc-8", "ppc-1", "ppc-3", "ppc-5", "ppc-7", "ppc-10", "ppc-12"};   
static const Char_t * slaves[]  = {"ppc-0", "ppc-0", "ppc-2", "ppc-2", "ppc-4", "ppc-4", "ppc-6", "ppc-6", "ppc-8", "ppc-1", "ppc-3", "ppc-5", "ppc-7", "ppc-10", "ppc-12"};
