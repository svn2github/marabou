...
//   TIter nn(gPad->GetListOfPrimitives());
//   cout << "----------------------------------------" << endl;
//   while (TObject *oo = nn()) {
//      cout << "TSplineX:Paint() ent: " << oo << " " << oo->ClassName() << endl;
 //  }
...
//      cout << "----------------------------------------" << endl;
//      TIter nnn(gPad->GetListOfPrimitives());
//      while (TObject *oo = nnn()) {
//         cout << "TSplineX:Paint() out: " << oo << " " << oo->ClassName() << endl;
//      }
      return;
   }
