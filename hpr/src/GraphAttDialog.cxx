...
void GraphAttDialog::RestoreDefaults()
{
   ...
   fGraphSimpleLine = env.GetValue("GraphAttDialog.fGraphSimpleLine", 1);  fGraphFill = env.GetValue("GraphAttDialog.fGraphFill", 0);
   ...
   fGraphShowAxis = env.GetValue("GraphAttDialog.fGraphShowAxis", 0);
   fGraphLStyle = env.GetValue("GraphAttDialog.fGraphLStyle", 0);
   fGraphLWidth = env.GetValue("GraphAttDialog.fGraphLWidth", 0);
   fGraphLColor = env.GetValue("GraphAttDialog.fGraphLColor", 0);
   fGraphMStyle = env.GetValue("GraphAttDialog.fGraphMStyle", 0);
   fGraphMSize = env.GetValue("GraphAttDialog.fGraphMSize", 0);
}
//______________________________________________________________________
