...
// Author:         R. Lutter
// Revision:       $Id: TSnkDDA0816.h,v 1.1 2009-03-26 11:18:28 Rudolf.Lutter Exp $       
// Date:           
// URL:            
// Keywords:       
//////////////////////////////////////////////////////////////////////////////
...
class TSnkDDA0816 : public TNamed {
	...
	public:
		...
		inline void SetCycleCount(Int_t Cycles) { fCycleCount = Cycles; };
		inline Int_t GetCycleCount() { return(fCycleCount); };
		...
		inline Int_t GetMaxPoints() { return(fMaxPoints); };

		inline Double_t GetCalibration(Int_t XorY) { return(IsXorY(XorY) ? this->GetDac(XorY)->GetCalibration() : 1.); };
		...
		Bool_t Calibrate(	Int_t ChargeState,						// calibration
							Double_t Energy,
							Double_t CalibX, Double_t VoltageX,
							Double_t CalibY, Double_t VoltageY);
	...
	protected:
		...
		Int_t fCycleCount;				// number of cycles to perform
										// will be applied to "slow" channel only
