...
enum EM2L_FunctionType {
	...
	kM2L_FCT_SIS_3302_READ_RAW_DATA_BUF_CONFIG,
	kM2L_FCT_SIS_3302_WRITE_RAW_DATA_BUF_CONFIG,
...
const SMrbNamedXShort kMrbLofFunctionTypes[] =
	{
		...
		{kM2L_FCT_SIS_3302_READ_RAW_DATA_BUF_CONFIG,	"read raw data buffer configuration"},
		{kM2L_FCT_SIS_3302_WRITE_RAW_DATA_BUF_CONFIG,	"write raw data buffer configuration"},
