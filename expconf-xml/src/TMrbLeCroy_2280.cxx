...
//////////////////////////////////////////////////////////////////////////////
// Name:           expconf/src/TMrbLeCroy_2280.cxx
// Purpose:        MARaBOU configuration: LeCroy QDC
// Description:    Implements class methods to handle LeCroy type 2280
// Keywords:
// Author:         R. Lutter
// Mailto:         <a href=mailto:rudi.lutter@physik.uni-muenchen.de>R. Lutter</a>
// Revision:       $Id: TMrbLeCroy_2280.cxx,v 1.1 2008-03-05 12:37:16 Rudolf.Lutter Exp $       
// Date:           
//////////////////////////////////////////////////////////////////////////////
...
ClassImp(TMrbLeCroy_2280)

TMrbLeCroy_2280::TMrbLeCroy_2280(const Char_t * ModuleName, const Char_t * ModulePosition) :
										TMrbCamacModule(ModuleName, "LeCroy_2280", ModulePosition, 0, 48, 4096) {
//__________________________________________________________________[C++ CTOR]
//////////////////////////////////////////////////////////////////////////////
// Name:           TMrbLeCroy_2280
// Purpose:        Create an ADC of type LeCroy 2280
// Arguments:      Char_t * ModuleName      -- name of camac module
//                 Char_t * ModulePosition  -- B.C.N for this module
// Results:        --
// Exceptions:
// Description:    Creates a camac module of type LeCroy 2280.
// Keywords:
//////////////////////////////////////////////////////////////////////////////
	...
	if (!this->IsZombie()) {
		if (gMrbConfig == NULL) {
			...
			SetTitle("LeCroy 2280 QDC 48 x 4096 ch"); 	// store module type
...
Bool_t TMrbLeCroy_2280::MakeReadoutCode(ofstream & RdoStrm, TMrbConfig::EMrbModuleTag TagIndex) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           TMrbLeCroy_2280::MakeReadoutCode
...
// Exceptions:
// Description:    Writes code for readout of a lecroy 2280 module.
// Keywords:
//////////////////////////////////////////////////////////////////////////////
