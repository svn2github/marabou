...
// Revision:       $Id: TMrbCNAF.cxx,v 1.1 2008-03-05 12:37:16 Rudolf.Lutter Exp $       
// Date:           
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
	...
	TMrbCNAF * thisCnaf = new TMrbCNAF();

	TString cnaf = Form("%s.", BorCNAF);
	cnaf.ToUpper();
	Char_t * sp1 = cnaf.Data();
	Bool_t ok = kTRUE;

	for (;;) {
		while (isspace(*sp1)) sp1++;
		Char_t * sp2 = strchr(sp1, '.');
		if (sp2 == NULL) break;
		*sp2 = '\0';
		Bool_t iscnaf;
		if (isalpha(*sp1)) {
