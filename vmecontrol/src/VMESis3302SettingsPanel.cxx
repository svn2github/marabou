...
ClassImp(VMESis3302SettingsPanel)

const SMrbNamedXShort kVMEClockSource[] =
			{
				{VMESis3302SettingsPanel::kVMEClockSource100,		"100 MHz"		},
				{VMESis3302SettingsPanel::kVMEClockSource50,		"50 MHz"		},
				{VMESis3302SettingsPanel::kVMEClockSource25,		"25 MHz"		},
				{VMESis3302SettingsPanel::kVMEClockSource10,		"10 MHz"		},
				{VMESis3302SettingsPanel::kVMEClockSource1, 		"1 MHz"			},
				{VMESis3302SettingsPanel::kVMEClockSourceExt,		"extern"		},
				{0, 												NULL			}
			};

const SMrbNamedX kVMECommonTrigMode[] =
			{
				{VMESis3302SettingsPanel::kVMETrigModeIntern,		"intern/async", "internal/async trigger: FIR trigger"	},
				{VMESis3302SettingsPanel::kVMETrigModeExtern, 		"extern/sync", "external/sync trigger: via LEMO-3 or VME KEY"	},
				{VMESis3302SettingsPanel::kVMETrigModeLemo2,		"ts clear", "enable timestamp clear via LEMO-2"	},
				{VMESis3302SettingsPanel::kVMETrigModeLemo3, 		"xtrig ena", "enable external trigger via LEMO-3"	},
				{0, 												NULL			}
			};

const SMrbNamedX kVMETrigPolar[] =
			{
				{VMESis3302SettingsPanel::kVMETrigPolPos,			"positive", "trigger polarity positive"	},
				{VMESis3302SettingsPanel::kVMETrigPolNeg,			"negative", "trigger polarity negative"	},
				{0, 												NULL			}
			};

const SMrbNamedX kVMETrigCond[] =
			{
				{VMESis3302SettingsPanel::kVMETrigCondDis,			"disabled", "output trigger disabled"	},
				{VMESis3302SettingsPanel::kVMETrigCondGTEna,		"enabled if GT", "output if greater than treshold"	},
				{VMESis3302SettingsPanel::kVMETrigCondGTDis,		"disabled if GT", "no output if greater than treshold"	},
				{VMESis3302SettingsPanel::kVMETrigCondEna,			"enabled", "output trigger enabled"	},
				{0, 												NULL			}
			};

const SMrbNamedX kVMETrigMode[] =
			{
				{VMESis3302SettingsPanel::kVMETrigModeDis,			"disabled", "no trigger"	},
				{VMESis3302SettingsPanel::kVMETrigModeIntern,		"intern/async", "internal/async trigger: FIR trigger"	},
				{VMESis3302SettingsPanel::kVMETrigModeExtern, 		"extern/sync", "external/sync trigger: via LEMO-3 or VME KEY"	},
				{VMESis3302SettingsPanel::kVMETrigModeBoth, 		"intern+extern", "OR of intern and extern triggers"	},
				{0, 												NULL			}
			};

const SMrbNamedX kVMEDecim[] =
			{
				{VMESis3302SettingsPanel::kVMEDecimDis,				"disabled", "no decimation"	},
				{VMESis3302SettingsPanel::kVMEDecim2,				"2", "decimation = 2"	},
				{VMESis3302SettingsPanel::kVMEDecim4,				"4", "decimation = 4"	},
				{VMESis3302SettingsPanel::kVMEDecim8,				"8", "decimation = 8"	},
				{0, 												NULL			}
			};

const SMrbNamedX kVMESample[] =
			{
				{VMESis3302SettingsPanel::kVMESampleFull,			"full trace", "full trace (510 steps) + min/max"	},
...
VMESis3302SettingsPanel::VMESis3302SettingsPanel(TGCompositeFrame * TabFrame, TMrbLofNamedX * LofModules) :
...
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::UpdateGUI
...
void VMESis3302SettingsPanel::ModuleChanged(Int_t FrameId, Int_t Selection) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::ModuleChanged()
...
void VMESis3302SettingsPanel::ChannelChanged(Int_t FrameId, Int_t Selection) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::ChannelChanged
...
void VMESis3302SettingsPanel::ClockSourceChanged(Int_t FrameId, Int_t Selection) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::ClockSourceChanged
...
void VMESis3302SettingsPanel::CommonTrigModeChanged(Int_t FrameId, Int_t Selection) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::CommonTrigModeChanged
...
void VMESis3302SettingsPanel::DacOffsetChanged(Int_t FrameId, Int_t EntryNo) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::DacOffsetChanged
...
void VMESis3302SettingsPanel::TrigModeChanged(Int_t FrameId, Int_t Selection) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::TrigModeChanged
// Purpose:        Slot method: trigger mode changed
// Arguments:      Int_t FrameId     -- frame id (ignored)
//                 Int_t Selection   -- selection
// Exceptions:     
...
void VMESis3302SettingsPanel::TrigPeakingChanged(Int_t FrameId, Int_t EntryNo) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::TrigPeakingtChanged
...
void VMESis3302SettingsPanel::TrigGapChanged(Int_t FrameId, Int_t EntryNo) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::TrigGapChanged
// Purpose:        Slot method: trigger settings changed
// Arguments:      Int_t FrameId     -- frame id (ignored)
//                 Int_t EntryNo     -- entry (ignored)
// Results:        --
...
void VMESis3302SettingsPanel::TrigThreshChanged(Int_t FrameId, Int_t EntryNo) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::TrigThreshChanged
// Purpose:        Slot method: trigger settings changed
// Arguments:      Int_t FrameId     -- frame id (ignored)
//                 Int_t EntryNo     -- entry (ignored)
// Results:        --
...
void VMESis3302SettingsPanel::TrigPolarChanged(Int_t FrameId, Int_t Selection) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::TrigPolarChanged
// Purpose:        Slot method: trigger settings changed
// Arguments:      Int_t FrameId     -- frame id (ignored)
//                 Int_t Selection   -- selection
// Exceptions:     
...
void VMESis3302SettingsPanel::TrigCondChanged(Int_t FrameId, Int_t Selection) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::TrigCondChanged
// Purpose:        Slot method: trigger settings changed
// Arguments:      Int_t FrameId     -- frame id (ignored)
//                 Int_t Selection   -- selection
// Exceptions:     
...
void VMESis3302SettingsPanel::TrigOutChanged(Int_t FrameId, Int_t EntryNo) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::TrigOutChanged
// Purpose:        Slot method: trigger settings changed
// Arguments:      Int_t FrameId     -- frame id (ignored)
//                 Int_t EntryNo     -- entry (ignored)
// Results:        --
...
void VMESis3302SettingsPanel::TrigDelayChanged(Int_t FrameId, Int_t EntryNo) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::TrigDelayChanged
// Purpose:        Slot method: trigger settings changed
// Arguments:      Int_t FrameId     -- frame id (ignored)
//                 Int_t EntryNo     -- entry (ignored)
// Results:        --
...
void VMESis3302SettingsPanel::EnergyPeakingChanged(Int_t FrameId, Int_t EntryNo) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::EnergyPeakingChanged
// Purpose:        Slot method: trigger settings changed
// Arguments:      Int_t FrameId     -- frame id (ignored)
//                 Int_t EntryNo     -- entry (ignored)
// Results:        --
...
void VMESis3302SettingsPanel::EnergyGapChanged(Int_t FrameId, Int_t EntryNo) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::EnergyGapChanged
// Purpose:        Slot method: trigger settings changed
// Arguments:      Int_t FrameId     -- frame id (ignored)
//                 Int_t EntryNo     -- entry (ignored)
// Results:        --
...
void VMESis3302SettingsPanel::DecimationChanged(Int_t FrameId, Int_t Selection) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::DecimationChanged
// Purpose:        Slot method: trigger settings changed
// Arguments:      Int_t FrameId     -- frame id (ignored)
//                 Int_t Selection   -- selection
// Exceptions:     
...
void VMESis3302SettingsPanel::TauFactorChanged(Int_t FrameId, Int_t EntryNo) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::TauFactorChanged
// Purpose:        Slot method: trigger settings changed
// Arguments:      Int_t FrameId     -- frame id (ignored)
//                 Int_t EntryNo     -- entry (ignored)
// Results:        --
...
void VMESis3302SettingsPanel::RawDataStartChanged(Int_t FrameId, Int_t EntryNo) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::RawDataStartChanged
// Purpose:        Slot method: trigger settings changed
// Arguments:      Int_t FrameId     -- frame id (ignored)
//                 Int_t EntryNo     -- entry (ignored)
// Results:        --
...
void VMESis3302SettingsPanel::RawDataLengthChanged(Int_t FrameId, Int_t EntryNo) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::RawDataLengthChanged
// Purpose:        Slot method: trigger settings changed
// Arguments:      Int_t FrameId     -- frame id (ignored)
//                 Int_t EntryNo     -- entry (ignored)
// Results:        --
...
void VMESis3302SettingsPanel::EnergyDataModeChanged(Int_t FrameId, Int_t Selection) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::EnergyDataModeChanged
// Purpose:        Slot method: trigger settings changed
// Arguments:      Int_t FrameId     -- frame id (ignored)
//                 Int_t Selection   -- selection
// Exceptions:     
...
void VMESis3302SettingsPanel::EnergyDataStart1Changed(Int_t FrameId, Int_t EntryNo) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::EnergyDataStart1Changed
// Purpose:        Slot method: trigger settings changed
// Arguments:      Int_t FrameId     -- frame id (ignored)
//                 Int_t EntryNo     -- entry (ignored)
// Results:        --
...
void VMESis3302SettingsPanel::EnergyDataStart2Changed(Int_t FrameId, Int_t EntryNo) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::EnergyDataStart2Changed
// Purpose:        Slot method: trigger settings changed
// Arguments:      Int_t FrameId     -- frame id (ignored)
//                 Int_t EntryNo     -- entry (ignored)
// Results:        --
...
void VMESis3302SettingsPanel::EnergyDataStart3Changed(Int_t FrameId, Int_t EntryNo) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::EnergyDataStart3Changed
// Purpose:        Slot method: trigger settings changed
// Arguments:      Int_t FrameId     -- frame id (ignored)
//                 Int_t EntryNo     -- entry (ignored)
// Results:        --
...
void VMESis3302SettingsPanel::EnergyDataStartChanged(Int_t IdxNo, TGMrbLabelEntry * Entry, Int_t EntryNo) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::EnergyDataStartChanged
// Purpose:        Slot method: trigger settings changed
// Arguments:      Int_t FrameId     -- frame id (ignored)
//                 Int_t EntryNo     -- entry (ignored)
// Results:        --
...
void VMESis3302SettingsPanel::EnergyDataLengthChanged(Int_t FrameId, Int_t EntryNo) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::EnergyDataLengthChanged
// Purpose:        Slot method: trigger settings changed
// Arguments:      Int_t FrameId     -- frame id (ignored)
//                 Int_t EntryNo     -- entry (ignored)
// Results:        --
...
void VMESis3302SettingsPanel::UpdateAdcCounts() {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::TrigGapChanged
...
void VMESis3302SettingsPanel::UpdateDecayTime() {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::UpdateDecayTime
...
void VMESis3302SettingsPanel::UpdateGates() {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           VMESis3302SettingsPanel::UpdateEnergyWindows
