...
/*                                                                    */
/*--------------------------------------------------------------------*/
/*+ CALLING     : int ctgl(long EXT, int *L)                          */
/*--------------------------------------------------------------------*/
/*                                                                    */
/*+ PURPOSE     : Test Crate Demand present                           */
/*                                                                    */
/*2+Description***+***********+****************************************/
/*                                                                    */
/*+ ARGUMENTS   :                                                     */
...
/*+       L     : flag returning crate demand status                  */
/*                                                                    */
...
/*                any demand is present in the crate specified by                   */
/*                ext and sets L to 0x0 if no demand is present.                    */
/*                                                                    */
/*2+Implementation************+****************************************/
/*+ File name   : ctgl.c                                              */
...
int ctgl (struct camacadd *ext_p, int *lptr)
{
    struct camacadd ext;
    int q,
        status,
