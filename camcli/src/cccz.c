...
/*3+Function******+***********+****************************************/
/*                                                                    */
/*                This procedure causes a Dataway initialize (Z) to be              */
...
int cccz (struct camacadd *ext_p)
{
    struct camacadd ext;
    int status,
        x;
	...
	switch (_cam_ctrl_type) {
		case C_CC32:
    		ext.n_station = N_Z_CC32;
			ext.n_address = A_Z_CC32;
			ext.n_function = F_Z_CC32;
			break;
		case C_CBV:
		default:
    		ext.n_station = N_Z_CBV;
			ext.n_address = A_Z_CBV;
			ext.n_function = F_Z_CBV;
			break;
	}
