...
// Author:         R. Lutter
// Revision:       $Id: DGFTauDisplayPanel.h,v 1.1 2009-09-23 10:46:23 Marabou Exp $       
// Date:           
// URL:            
// Keywords:       
//////////////////////////////////////////////////////////////////////////////
...
class DGFTauDisplayPanel : public TGCompositeFrame {
	...
	protected:
		...
		TNGMrbLabelEntry * fNofTracesEntry; 			//		number of traces
		TNGMrbLabelEntry * fXwaitEntry;				//		wait states

		TGHorizontalFrame * fHFrame;

		TGGroupFrame * fFitFrame;					//	fit
		TNGMrbRadioButtonList * fFitTraceYesNo; 		//		yes/no
		TNGMrbLabelEntry * fFitFromEntry; 			//		from
		TNGMrbLabelEntry * fFitToEntry;	 			//		to
		TNGMrbLabelEntry * fFitA0Entry;	 			//		A0
		TNGMrbLabelEntry * fFitA1Entry;  			//		A1
		TNGMrbLabelEntry * fFitA2Entry;  			//		A2
		TNGMrbLabelEntry * fFitErrorEntry; 			//		error
		TNGMrbLabelEntry * fFitChiSquareEntry; 		//		chi square

		TGGroupFrame * fDisplayFrame;				//	display
		TNGMrbLabelEntry * fDispTraceNoEntry; 		//		trace number
		TNGMrbRadioButtonList * fDispStatBox; 		//		stat box yes/no
		TNGMrbLabelEntry * fDispCurTauEntry;  		//		current tau
		TNGMrbLabelEntry * fDispBestTauEntry; 		//		best tau
		TNGMrbFileEntry * fDispFileEntry;	 		//		trace file
