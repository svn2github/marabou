...
// Author:         R. Lutter
// Revision:       $Id: DGFSetupPanel.h,v 1.1 2009-09-23 10:46:23 Marabou Exp $       
// Date:           
// URL:            
// Keywords:       
//////////////////////////////////////////////////////////////////////////////
...
class DGFSetupPanel : public TGCompositeFrame {
	...
	protected:
		...
		TNGMrbLabelCombo * fCAMACHostEntry;			//		default host
		TMrbLofNamedX * fCAMACHostEntryStrings;
		TNGMrbCheckButtonGroup * fDGFFrame;			// dgf defs
		TGGroupFrame * fCodeFrame;			 		// codes to be loaded
		TNGMrbCheckButtonList * fCodes;
		TNGMrbRadioButtonList * fBroadCast;
		TGGroupFrame * fModules;			 		// module list
		TNGMrbCheckButtonList * fCluster[kNofClusters];
		TGHorizontalFrame * fSelectFrame;
		TNGMrbPictureButtonList * fColSelect[kNofModulesPerCluster];
		TNGMrbPictureButtonList * fAllSelect;
		TNGMrbTextButtonGroup * fActionFrame;		// connect to camac
