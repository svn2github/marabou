...
// Revision:       $Id: DGFTraceDisplayPanel.cxx,v 1.1 2009-09-23 10:46:24 Marabou Exp $       
// Date:           
// URL:            
// Keywords:       
// Layout:
...
// modules
	...
	fTFrame = new TGGroupFrame(fHFrame, "TraceLength", kHorizontalFrame,  stdProfile->GetGC(TNGMrbGContext::kGMrbGCGroupFrame)->GC(),  stdProfile->GetGC(TNGMrbGContext::kGMrbGCGroupFrame)->Font(),  stdProfile->GetGC(TNGMrbGContext::kGMrbGCGroupFrame)->BG());
	HEAP(fTFrame);
	fHFrame->AddFrame(fTFrame, dgfFrameLayout);

	TGLayoutHints * dgfLabelEntryLayout = new TGLayoutHints(kLHintsRight | kLHintsExpandX, 2, 1, 2, 1);
	HEAP(dgfLabelEntryLayout);

	fTraceLength = new TNGMrbLabelEntry(fTFrame, "Trace Length",
																kDGFTraceDisplayTraceLength,stdProfile,
																kLEWidth,
																kLEHeight,
																150,TNGMrbLabelEntry::kGMrbEntryHasUpDownButtons|
																TNGMrbLabelEntry::kGMrbEntryIsNumber|
																TNGMrbLabelEntry::kGMrbEntryHasBeginEndButtons);
	HEAP(fTraceLength);
	fTFrame->AddFrame(fTraceLength, dgfLabelEntryLayout);
// 	fTraceLength->SetType(TGMrbLabelEntry::kGMrbEntryTypeInt);
	fTraceLength->SetFormat(TGNumberEntry::kNESRealOne);
	fTraceLength->SetIntNumber(0);
// 	fTraceLength->SetRange(0, 8000);
	fTraceLength->SetLimits(TGNumberEntry::kNELLimitMinMax,0,8000);
	...
	fXwait = new TNGMrbLabelEntry(fXFrame, "Xwait",
																kDGFTraceDisplayXwait,stdProfile,
																kLEWidth,
																kLEHeight,
																150,TNGMrbLabelEntry::kGMrbEntryHasUpDownButtons|
																TNGMrbLabelEntry::kGMrbEntryIsNumber|
...
// 	fXwait->SetType(TGMrbLabelEntry::kGMrbEntryTypeInt);
	fXwait->SetFormat(TGNumberEntry::kNESRealOne);
...
//////////////////////////////////////////////////////////////////////////////
	...
	traceLength = fTraceLength->GetIntNumber();
