...
// Revision:       $Id: DGFTauDisplayPanel.cxx,v 1.1 2009-09-23 10:46:24 Marabou Exp $       
// Date:           
// URL:            
// Keywords:       
// Layout:
...
// 	buttonGC->SetLH(scbLayout);
	...
	fSelectChannel = new TNGMrbRadioButtonList(fSelectFrame,  "Channel", &fLofChannels,
													kDGFTauSelectChannel,stdProfile, 1,0, 
													kTabWidth, kLEHeight);
	HEAP(fSelectChannel);
...
// 	gDGFControlData->SetLH(groupGC, frameGC, traceLayout);
	HEAP(traceLayout);
	fTraceFrame = new TGGroupFrame(this, "Trace Settings", kHorizontalFrame,  stdProfile->GetGC(TNGMrbGContext::kGMrbGCGroupFrame)->GC(),  stdProfile->GetGC(TNGMrbGContext::kGMrbGCGroupFrame)->Font(),  stdProfile->GetGC(TNGMrbGContext::kGMrbGCGroupFrame)->BG());
	HEAP(fTraceFrame);
	this->AddFrame(fTraceFrame,scfLayout);

	TGLayoutHints * teLayout = new TGLayoutHints(kLHintsTop, 1, 1, 1, 1);
// 	entryGC->SetLH(teLayout);
	HEAP(teLayout);
	fTraceLengthEntry = new TNGMrbLabelEntry(fTraceFrame, "Trace length [samples]",
																kDGFTauTraceLength,stdProfile,
																kLEWidth,
																kLEHeight,
	...
	fTraceFrame->AddFrame(fTraceLengthEntry, traceLayout);
// 	fTraceLengthEntry->SetType(TGMrbLabelEntry::kGMrbEntryTypeInt);
	fTraceLengthEntry->SetFormat(TGNumberEntry::kNESInteger);
	fTraceLengthEntry->SetIntNumber(8001);
// 	fTraceLengthEntry->SetRange(100, 8001);
	fTraceLengthEntry->SetLimits(TGNumberEntry::kNELLimitMinMax,100,8001);
	...
	fXwaitEntry = new TNGMrbLabelEntry(fTraceFrame, "Xwait states",
																kDGFTauXwait,stdProfile,
																kLEWidth,
																kLEHeight,
																(Int_t) (1.5 * kEntryWidth),
																TNGMrbLabelEntry::kGMrbEntryIsNumber|
																...
																TNGMrbLabelEntry::kGMrbEntryHasBeginEndButtons);
	HEAP(fXwaitEntry);
	fTraceFrame->AddFrame(fXwaitEntry, traceLayout);
// 	fXwaitEntry->SetType(TGMrbLabelEntry::kGMrbEntryTypeInt);
	fXwaitEntry->SetFormat(TGNumberEntry::kNESInteger);
	fXwaitEntry->SetNumber(10);
// 	fXwaitEntry->SetRange(0, 1000);
	fXwaitEntry->SetLimits(TGNumberEntry::kNELLimitMinMax,0,1000);
	fXwaitEntry->SetIncrement(1);
	fXwaitEntry->AddToFocusList(&fFocusList);

	fNofTracesEntry = new TNGMrbLabelEntry(fTraceFrame, "Number of traces",
																kDGFTauTraceNofTraces,stdProfile,
																kLEWidth,
																kLEHeight,
																(Int_t) (1.5 * kEntryWidth),
																TNGMrbLabelEntry::kGMrbEntryIsNumber|
	...
	fTraceFrame->AddFrame(fNofTracesEntry, traceLayout);
// 	fNofTracesEntry->SetType(TGMrbLabelEntry::kGMrbEntryTypeInt);
	fNofTracesEntry->SetFormat(TGNumberEntry::kNESInteger);
	fNofTracesEntry->SetNumber(1);
// 	fNofTracesEntry->SetRange(0, 99);
	fNofTracesEntry->SetLimits(TGNumberEntry::kNELLimitMinMax,0,99);
	fNofTracesEntry->SetIncrement(1);
	fNofTracesEntry->AddToFocusList(&fFocusList);
	fNofTracesEntry->Connect("EntryChanged(Int_t)", this->ClassName(), this, "EntryChanged(Int_t)");

// fit settings
	fHFrame = new TGHorizontalFrame(this, kTabWidth, kTabHeight, kChildFrame, stdProfile->GetGC(TNGMrbGContext::kGMrbGCFrame)->BG());
	HEAP(fHFrame);
	this->AddFrame(fHFrame, traceLayout);
...
// 	gDGFControlData->SetLH(groupGC, frameGC, fitLayout);
	HEAP(fitLayout);
	fFitFrame = new TGGroupFrame(fHFrame, "Fit Settings", kVerticalFrame,  stdProfile->GetGC(TNGMrbGContext::kGMrbGCGroupFrame)->GC(),  stdProfile->GetGC(TNGMrbGContext::kGMrbGCGroupFrame)->Font(),  stdProfile->GetGC(TNGMrbGContext::kGMrbGCGroupFrame)->BG());
	HEAP(fFitFrame);
	fHFrame->AddFrame(fFitFrame, fitLayout);

	TGLayoutHints * rbLayout = new TGLayoutHints(kLHintsRight, 1, 1, 1, 1);
// 	rbuttonGC->SetLH(rbLayout);
	HEAP(rbLayout);
	fFitTraceYesNo = new TNGMrbRadioButtonList(fFitFrame,  "Fit trace", &fFitTraceButtons, -1,stdProfile, 1,0, 
													kTabWidth, kLEHeight);
	HEAP(fFitTraceYesNo);
	fFitFrame->AddFrame(fFitTraceYesNo, fitLayout);

// 	frameGC->SetLH(fitLayout);
	TGLayoutHints * feLayout = new TGLayoutHints(kLHintsTop, 1, 1, 1, 1);
// 	entryGC->SetLH(feLayout);
	HEAP(feLayout);
	fFitFromEntry = new TNGMrbLabelEntry(fFitFrame, "From sample",
																kDGFTauFitFrom,stdProfile,
																kLEWidth,
																kLEHeight,
																(Int_t) (1.5 * kEntryWidth),
																TNGMrbLabelEntry::kGMrbEntryIsNumber|
																...
																TNGMrbLabelEntry::kGMrbEntryHasBeginEndButtons);
	HEAP(fFitFromEntry);
	fFitFrame->AddFrame(fFitFromEntry, fitLayout);
// 	fFitFromEntry->SetType(TGMrbLabelEntry::kGMrbEntryTypeInt);
	fFitFromEntry->SetFormat(TGNumberEntry::kNESInteger);
	fFitFromEntry->SetLimits(TGNumberEntry::kNELLimitMinMax,0,8001);
	fFitFromEntry->SetNumber(0);
// 	fFitFromEntry->SetRange(0, 8001);
	fFitFromEntry->SetIncrement(100);
	fFitFromEntry->AddToFocusList(&fFocusList);
	fFitFromEntry->Connect("EntryChanged(Int_t)", this->ClassName(), this, "EntryChanged(Int_t)");

	fFitToEntry = new TNGMrbLabelEntry(fFitFrame, "To sample",
																kDGFTauFitTo,stdProfile,
																kLEWidth,
																kLEHeight,
																(Int_t) (1.5 * kEntryWidth),
																TNGMrbLabelEntry::kGMrbEntryIsNumber|
																...
																TNGMrbLabelEntry::kGMrbEntryHasBeginEndButtons);
	HEAP(fFitToEntry);
	fFitFrame->AddFrame(fFitToEntry, fitLayout);
// 	fFitToEntry->SetType(TGMrbLabelEntry::kGMrbEntryTypeInt);
	fFitToEntry->SetFormat(TGNumberEntry::kNESInteger);
	fFitToEntry->SetLimits(TGNumberEntry::kNELLimitMinMax,0,4095);
// 	fFitToEntry->SetRange(0, 4095);
	fFitToEntry->SetIncrement(100);
	fFitToEntry->AddToFocusList(&fFocusList);
	fFitToEntry->Connect("EntryChanged(Int_t)", this->ClassName(), this, "EntryChanged(Int_t)");

	fFitA0Entry = new TNGMrbLabelEntry(fFitFrame, "A0 (const)",
																kDGFTauFitParamA0,stdProfile,
																kLEWidth,
																kLEHeight,
																(Int_t) (1.5 * kEntryWidth),
																TNGMrbLabelEntry::kGMrbEntryIsNumber|
																...
																TNGMrbLabelEntry::kGMrbEntryHasBeginEndButtons);
	HEAP(fFitA0Entry);
	fFitFrame->AddFrame(fFitA0Entry, fitLayout);
// 	fFitA0Entry->SetType(TGMrbLabelEntry::kGMrbEntryTypeDouble);
// 	fFitA0Entry->SetRange(0, 10000);
	fFitA0Entry->SetFormat(TGNumberEntry::kNESRealTwo);
	fFitA0Entry->SetLimits(TGNumberEntry::kNELLimitMinMax,0,10000);
	fFitA0Entry->SetIncrement(100);
	fFitA0Entry->AddToFocusList(&fFocusList);
	fFitA0Entry->Connect("EntryChanged(Int_t)", this->ClassName(), this, "EntryChanged(Int_t)");

	fFitA1Entry = new TNGMrbLabelEntry(fFitFrame, "A1 (ampl)",
																kDGFTauFitParamA1,stdProfile,
																kLEWidth,
																kLEHeight,
																(Int_t) (1.5 * kEntryWidth),
																TNGMrbLabelEntry::kGMrbEntryIsNumber|
																...
																TNGMrbLabelEntry::kGMrbEntryHasBeginEndButtons);
	HEAP(fFitA1Entry);
	fFitFrame->AddFrame(fFitA1Entry, fitLayout);
// 	fFitA1Entry->SetType(TGMrbLabelEntry::kGMrbEntryTypeDouble);
// 	fFitA1Entry->SetRange(0, 20000);
	fFitA1Entry->SetFormat(TGNumberEntry::kNESRealTwo);
	fFitA1Entry->SetLimits(TGNumberEntry::kNELLimitMinMax,0,20000);
	fFitA1Entry->SetIncrement(100);
	fFitA1Entry->AddToFocusList(&fFocusList);
	fFitA1Entry->Connect("EntryChanged(Int_t)", this->ClassName(), this, "EntryChanged(Int_t)");

	fFitA2Entry = new TNGMrbLabelEntry(fFitFrame, "A2 (tau)",
																kDGFTauFitParamA2,stdProfile,
																kLEWidth,
																kLEHeight,
																(Int_t) (1.5 * kEntryWidth),
																TNGMrbLabelEntry::kGMrbEntryIsNumber|
																...
																TNGMrbLabelEntry::kGMrbEntryHasBeginEndButtons);
	HEAP(fFitA2Entry);
	fFitFrame->AddFrame(fFitA2Entry, fitLayout);
// 	fFitA2Entry->SetType(TGMrbLabelEntry::kGMrbEntryTypeDouble);
// 	fFitA2Entry->SetRange(0, 10000);
	fFitA2Entry->SetFormat(TGNumberEntry::kNESRealTwo);
	fFitA2Entry->SetLimits(TGNumberEntry::kNELLimitMinMax,0,10000);
	fFitA2Entry->SetIncrement(100);
	fFitA2Entry->AddToFocusList(&fFocusList);
	fFitA2Entry->Connect("EntryChanged(Int_t)", this->ClassName(), this, "EntryChanged(Int_t)");

	fFitErrorEntry = new TNGMrbLabelEntry(fFitFrame, "Error",
																kDGFTauFitError,stdProfile,
																kLEWidth,
																kLEHeight,
																(Int_t) (1.5 * kEntryWidth),
																TNGMrbLabelEntry::kGMrbEntryIsNumber|
																...
																TNGMrbLabelEntry::kGMrbEntryHasBeginEndButtons);
	HEAP(fFitErrorEntry);
	fFitFrame->AddFrame(fFitErrorEntry, fitLayout);
// 	fFitErrorEntry->SetType(TGMrbLabelEntry::kGMrbEntryTypeDouble);
// 	fFitErrorEntry->SetRange(0, 20);
	fFitErrorEntry->SetFormat(TGNumberEntry::kNESRealTwo);
	fFitErrorEntry->SetLimits(TGNumberEntry::kNELLimitMinMax,0,20);
	fFitErrorEntry->SetIncrement(.5);
	fFitErrorEntry->AddToFocusList(&fFocusList);
	fFitErrorEntry->Connect("EntryChanged(Int_t)", this->ClassName(), this, "EntryChanged(Int_t)");

	fFitChiSquareEntry = new TNGMrbLabelEntry(fFitFrame, "Chi square",
																kDGFTauFitChiSquare,stdProfile,
																kLEWidth,
																kLEHeight,
																(Int_t) (1.5 * kEntryWidth),
																TNGMrbLabelEntry::kGMrbEntryIsNumber|
	...
	fFitFrame->AddFrame(fFitChiSquareEntry, fitLayout);
// 	fFitChiSquareEntry->SetType(TGMrbLabelEntry::kGMrbEntryTypeDouble);
// 	fFitChiSquareEntry->SetRange(0, 20);
	fFitChiSquareEntry->SetFormat(TGNumberEntry::kNESRealTwo);
	fFitChiSquareEntry->SetLimits(TGNumberEntry::kNELLimitMinMax,0,20);
	fFitChiSquareEntry->SetIncrement(.5);
	fFitChiSquareEntry->AddToFocusList(&fFocusList);
	fFitChiSquareEntry->Connect("EntryChanged(Int_t)", this->ClassName(), this, "EntryChanged(Int_t)");
...
// 	gDGFControlData->SetLH(groupGC, frameGC, dispLayout);
	HEAP(dispLayout);
	fDisplayFrame = new TGGroupFrame(fHFrame, "Display", kVerticalFrame,  stdProfile->GetGC(TNGMrbGContext::kGMrbGCGroupFrame)->GC(),  stdProfile->GetGC(TNGMrbGContext::kGMrbGCGroupFrame)->Font(),  stdProfile->GetGC(TNGMrbGContext::kGMrbGCGroupFrame)->BG());
	HEAP(fDisplayFrame);
	fHFrame->AddFrame(fDisplayFrame, dispLayout);

	TGLayoutHints * deLayout = new TGLayoutHints(kLHintsTop, 1, 1, 1, 1);
// 	entryGC->SetLH(deLayout);
	HEAP(deLayout);
	fDispTraceNoEntry = new TNGMrbLabelEntry(fDisplayFrame, "Trace number",
																kDGFTauDispTraceNo,stdProfile,
																kLEWidth,
																kLEHeight,
																(Int_t) (1.5 * kEntryWidth),
																TNGMrbLabelEntry::kGMrbEntryIsNumber|
	...
	fDisplayFrame->AddFrame(fDispTraceNoEntry,dispLayout);
// 	fDispTraceNoEntry->SetType(TGMrbLabelEntry::kGMrbEntryTypeInt);
	fDispTraceNoEntry->SetFormat(TGNumberEntry::kNESRealTwo);
	fDispTraceNoEntry->SetLimits(TGNumberEntry::kNELLimitMinMax,0,99);
	fDispTraceNoEntry->SetNumber(0);
// 	fDispTraceNoEntry->SetRange(0, 99);
	fDispTraceNoEntry->SetIncrement(1);
	fDispTraceNoEntry->AddToFocusList(&fFocusList);
	fDispTraceNoEntry->Connect("EntryChanged(Int_t)", this->ClassName(), this, "EntryChanged(Int_t)");

	fDispStatBox = new TNGMrbRadioButtonList(fDisplayFrame,  "Stat box", &fDispStatBoxButtons, -1,stdProfile, 1, 0,
													kTabWidth, kLEHeight);
	HEAP(fDispStatBox);
	fDisplayFrame->AddFrame(fDispStatBox, dispLayout);

	fTraceFileInfo.fFileTypes = (const Char_t **) kDGFFileTypesTraces;
	fTraceFileInfo.fIniDir = StrDup(gDGFControlData->fDataPath);
	fDispFileEntry = new TNGMrbFileEntry(fDisplayFrame, "Trace file",
																&fTraceFileInfo, kFDOpen,
																stdProfile,kDGFTauDispFile,
																kLEWidth,
																kLEHeight,
																kFileEntryWidth);
	HEAP(fDispFileEntry);
	fDisplayFrame->AddFrame(fDispFileEntry,dispLayout);

	fDispCurTauEntry = new TNGMrbLabelEntry(fDisplayFrame, "Tau value",
																kDGFTauDispCurTau,stdProfile,
																kLEWidth,
																kLEHeight,
																(Int_t) (1.5 * kEntryWidth),
																TNGMrbLabelEntry::kGMrbEntryIsNumber|
	...
	fDisplayFrame->AddFrame(fDispCurTauEntry, dispLayout);
// 	fDispCurTauEntry->SetType(TGMrbLabelEntry::kGMrbEntryTypeDouble);
	fDispCurTauEntry->SetFormat(TGNumberEntry::kNESRealTwo);
// 	fDispTraceNoEntry->SetLimits(TGNumberEntry::kNELLimitMinMax,0,99);
	fDispCurTauEntry->SetNumber(0.0);
	fDispCurTauEntry->AddToFocusList(&fFocusList);
	fDispCurTauEntry->Connect("EntryChanged(Int_t)", this->ClassName(), this, "EntryChanged(Int_t)");

	fDispBestTauEntry = new TNGMrbLabelEntry(fDisplayFrame, "Best tau",
																kDGFTauDispBestTau,stdProfile,
																kLEWidth,
																kLEHeight,
																(Int_t) (1.5 * kEntryWidth),
																TNGMrbLabelEntry::kGMrbEntryIsNumber);
	HEAP(fDispBestTauEntry);
	fDisplayFrame->AddFrame(fDispBestTauEntry,dispLayout);
// 	fDispBestTauEntry->SetType(TGMrbLabelEntry::kGMrbEntryTypeDouble);
	fDispBestTauEntry->SetFormat(TGNumberEntry::kNESRealTwo);
	fDispBestTauEntry->SetNumber(0.0);
...
// 	buttonGC->SetLH(btnLayout);
	HEAP(btnLayout);
	fButtonFrame = new TNGMrbTextButtonGroup(this, "Actions", &fTauActions, -1,stdProfile, 1,0);
	HEAP(fButtonFrame);
...
//////////////////////////////////////////////////////////////////////////////
	...
	switch (Selection) {
		...
		case kDGFTauButtonTauOK:
			tau = fDispCurTauEntry->GetNumber();
			dgf->SetTau(chn, tau);
			break;
		case kDGFTauButtonBestTau:
			tau = fDispBestTauEntry->GetNumber();
			dgf->SetTau(chn, tau);
			break;
...
void DGFTauDisplayPanel::EntryChanged(Int_t Selection) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
	...
	traceLength = fTraceLengthEntry->GetIntNumber();
	xwait = fXwaitEntry->GetIntNumber();
	nofTraces = fNofTracesEntry->GetIntNumber();
...
// 	fDispTraceNoEntry->SetRange(0, nofTraces - 1);
	fDispTraceNoEntry->SetLimits(TGNumberEntry::kNELLimitMinMax,0, nofTraces - 1);

// 	fFitFromEntry->SetRange(0, traceLength);
	fFitFromEntry->SetLimits(TGNumberEntry::kNELLimitMinMax,0,traceLength);
// 	fFitToEntry->SetRange(0, traceLength);
	fFitToEntry->SetLimits(TGNumberEntry::kNELLimitMinMax,0,traceLength);

	fitFrom = fFitFromEntry->GetIntNumber();
	fitTo = fFitToEntry->GetIntNumber();
	if (fitTo > traceLength) {
		fitTo = traceLength;
		fFitToEntry->SetNumber(fitTo);
	}
...
// 	fFitFromEntry->SetRange(0, traceLength);
	...
	fitError = fFitErrorEntry->GetNumber();
	fitChiSquare = fFitChiSquareEntry->GetNumber();
	fitA0 = fFitA0Entry->GetNumber();
	fitA1 = fFitA1Entry->GetNumber();
	fitA2 = fFitA2Entry->GetNumber();
...
//////////////////////////////////////////////////////////////////////////////
	...
	switch (EntryId) {
		case kDGFTauDispTraceNo:
			traceNo = fDispTraceNoEntry->GetIntNumber();
			if (fTraceFile == NULL) {
...
//////////////////////////////////////////////////////////////////////////////
	...
	fTraceLengthEntry->SetNumber(8001);
	fXwaitEntry->SetNumber(10);
	fNofTracesEntry->SetNumber(1);
	fFitFromEntry->SetNumber(0);
	fFitToEntry->SetNumber(200);
	fFitA0Entry->SetNumber(1000);
	fFitA1Entry->SetNumber(1000);
	fFitA2Entry->SetNumber(2000);
	fFitErrorEntry->SetNumber(2.0);
	fFitChiSquareEntry->SetNumber(5.0);
	fDispTraceNoEntry->SetNumber(0);
	fDispCurTauEntry->SetNumber(0.0);
