...
//   n1 = TMath::Min(n1, Length()-pos);
   if(n1 > Length()-pos)n1 = Length()-pos;
   if (!cs) n2 = 0;
...
{
   printf("TSubString::SubStringError",
...
void TSubString::AssertElement(Ssiz_t i) const
{
   ...
   if (i == kNPOS || i >= Length())
      printf("TSubString::AssertElement",
