...
// Revision:       $Id: DGFTauFitPanel.cxx,v 1.5 2004-09-28 13:47:32 rudi Exp $       
// Date:           
// URL:            
// Keywords:       
// Layout:
...
// accu settings
	...
	fTimeScale = new TGMrbRadioButtonList(fAccuFrame,  NULL, &fTauFitTimeScaleButtons, 1, 
													kTabWidth, kLEHeight,
...
//	buttons
	...
	HEAP(btnLayout);
	fButtonFrame = new TGMrbTextButtonGroup(this, "Actions", &fTauFitActions, 1, groupGC, buttonGC);
	HEAP(fButtonFrame);
