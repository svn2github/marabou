...
// Class:          TMrbSubevent_Data_I    -- MBS subevent type [10,92]
...
// Purpose:        Define MBS subevents of type [10,92]
// Description:    Defines a MBS subevent of type [10,92]. Generates code.
// Keywords:
//////////////////////////////////////////////////////////////////////////////
...
class TMrbSubevent_Data_I : public TMrbSubevent {
	...
	public:
		...
		TMrbSubevent_Data_I(const Char_t * SevtName, const Char_t * SevtTitle = "", Int_t NofWords = 1000, Int_t Crate = -1);	// create a new [10,92] subevent
	...
	ClassDef(TMrbSubevent_Data_I, 1)		// [Config] Subevent type [10,92]: plain integer data (32 bit)
};
