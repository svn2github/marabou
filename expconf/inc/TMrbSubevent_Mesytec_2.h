#ifndef __TMrbSubevent_Mesytec_2_h__
#define __TMrbSubevent_Mesytec_2_h__

//_________________________________________________[C++ CLASS DEFINITION FILE]
//////////////////////////////////////////////////////////////////////////////
// Name:           expconf/inc/TMrbSubevent_Mesytec_2.h
// Purpose:        Define experimental configuration for MARaBOU
// Class:          TMrbSubevent_Mesytec_2   -- MBS subevent type [10,82]
//                                          dedicated format Mesytec MADC32/MQDC32 modules
// Description:    Class definitions to implement a configuration front-end for MARaBOU
// Author:         R. Lutter
// Revision:       $Id: TMrbSubevent_Mesytec_2.h,v 1.2 2009-06-24 13:59:12 Rudolf.Lutter Exp $
...
class TMrbSubevent_Mesytec_2 : public TMrbSubevent {

	public:

		TMrbSubevent_Mesytec_2() {}; 				// default ctor
		TMrbSubevent_Mesytec_2(const Char_t * SevtName, const Char_t * SevtTitle = "", Int_t Crate = -1);	// create a new Mesytec subevent
		~TMrbSubevent_Mesytec_2() {};	 			// remove current subevent from list
	...
	ClassDef(TMrbSubevent_Mesytec_2, 1) 	// [Config] Subevent type [10,82]: a format dedicated to Mesytec MADC32/MQDC32 modules
};
