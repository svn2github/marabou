...
//////////////////////////////////////////////////////////////////////////////
// Name:           expconf/inc/TMrbSubevent_Caen_V1X90_3.h
// Purpose:        Define experimental configuration for MARaBOU
// Class:          TMrbSubevent_Caen_V1X90_3   -- MBS subevent type [10,47]
//                                         dedicated format for CAEN modules
// Description:    Class definitions to implement a configuration front-end for MARaBOU
// Author:         R. Lutter
// Revision:       $Id: TMrbSubevent_Caen_V1X90_3.h,v 1.1 2009-07-20 07:09:44 Marabou Exp $       
// Date:           
// Keywords:
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
// Name:           TMrbSubevent_Caen_V1X90_3
// Purpose:        Define MBS subevents of type [10,47]
// Methods:        MakeReadoutCode  -- output readout code for subevent [10,47]
// Description:    Defines a MBS subevent of type [10,47] - a special format
...
class TMrbSubevent_Caen_V1X90_3 : public TMrbSubevent {
	...
	public:
		...
		TMrbSubevent_Caen_V1X90_3() {}; 				// default ctor
		TMrbSubevent_Caen_V1X90_3(const Char_t * SevtName, const Char_t * SevtTitle = "", Int_t Crate = -1);	// create a new CAEN subevent
		~TMrbSubevent_Caen_V1X90_3() {};	 			// remove current subevent from list
	...
	ClassDef(TMrbSubevent_Caen_V1X90_3, 1) 	// [Config] Subevent type [10,47]: a format dedicated to CAEN V1X90 modules
};
