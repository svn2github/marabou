...
class TMrbLeCroy_4432 : public TMrbCamacModule {
	...
	public:
		...
		virtual inline const Char_t * GetMnemonic() { return("lecroy_4432"); }; 	// module mnemonic

		inline void Help() { gSystem->Exec("kdehelp /usr/local/Marabou/doc/html/TMrbLeCroy_4432.html&"); };
