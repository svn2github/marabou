...
// Author:         R. Lutter
// Revision:       $Id: TMrbSubevent_Madc_2.h,v 1.1 2009-04-20 13:41:05 Rudolf.Lutter Exp $       
...
class TMrbSubevent_Madc_2 : public TMrbSubevent {
	...
	public:
		...
		TMrbSubevent_Madc_2(const Char_t * SevtName, const Char_t * SevtTitle = "", Int_t Crate = -1);	// create a new DGF subevent
