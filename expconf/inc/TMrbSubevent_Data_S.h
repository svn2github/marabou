...
// Class:          TMrbSubevent_Data_S    -- MBS subevent type [10,91]
...
// Purpose:        Define MBS subevents of type [10,91]
// Description:    Defines a MBS subevent of type [10,91]. Generates code.
// Keywords:
//////////////////////////////////////////////////////////////////////////////
...
class TMrbSubevent_Data_S : public TMrbSubevent {
	...
	public:
		...
		TMrbSubevent_Data_S(const Char_t * SevtName, const Char_t * SevtTitle = "", Int_t NofWords = 1000, Int_t Crate = -1);	// create a new [10,91] subevent
	...
	ClassDef(TMrbSubevent_Data_S, 1)		// [Config] Subevent type [10,91]: plain integer data (16 bit)
};
