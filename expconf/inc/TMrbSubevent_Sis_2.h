...
// Author:         R. Lutter
// Revision:       $Id: TMrbSubevent_Sis_2.h,v 1.5 2004-09-28 13:47:32 rudi Exp $       
// Date:           
// Keywords:
//////////////////////////////////////////////////////////////////////////////
...
class TMrbSubevent_Sis_2 : public TMrbSubevent {
	...
	public:
		...
		TMrbSubevent_Sis_2(const Char_t * SevtName, const Char_t * SevtTitle = "", Int_t Crate = -1);	// create a new DGF subevent
		...
		inline void Help() { gSystem->Exec("kdehelp /usr/local/Marabou/doc/html/TMrbSubevent_Sis_2.html&"); };
