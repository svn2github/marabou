...
class TMrbGanelec_Q1612F : public TMrbCamacModule {
	...
	public:
		...
		virtual inline const Char_t * GetMnemonic() { return("gan_q1612f"); }; 	// module mnemonic

		inline void Help() { gSystem->Exec("kdehelp /usr/local/Marabou/doc/html/TMrbGanelec_Q1612F.html&"); };
