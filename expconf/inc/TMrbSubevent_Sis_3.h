...
// Author:         R. Lutter
// Revision:       $Id: TMrbSubevent_Sis_3.h,v 1.7 2009-06-24 13:59:12 Rudolf.Lutter Exp $       
// Date:           
// Keywords:
//////////////////////////////////////////////////////////////////////////////
...
class TMrbSubevent_Sis_3 : public TMrbSubevent {
	...
	public:
		...
		TMrbSubevent_Sis_3(const Char_t * SevtName, const Char_t * SevtTitle = "", Int_t Crate = -1);	// create a new SIS subevent
