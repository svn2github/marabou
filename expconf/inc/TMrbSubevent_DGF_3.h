...
class TMrbSubevent_DGF_3 : public TMrbSubevent {
	...
	public:
		...
		inline const Char_t * GetCommonCodeFile() { return("Subevent_DGF_3_Common"); };
		
		inline void Help() { gSystem->Exec("kdehelp /usr/local/Marabou/doc/html/TMrbSubevent_DGF_3.html&"); };
