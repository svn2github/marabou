...
//////////////////////////////////////////////////////////////////////////////
// Name:           expconf/src/TMrbLeCroy_4434.cxx
// Purpose:        MARaBOU configuration: LeCroy Modules
// Description:    Implements class methods to handle LeCroy type 4434
// Keywords:
// Author:         R. Lutter
// Mailto:         <a href=mailto:rudi.lutter@physik.uni-muenchen.de>R. Lutter</a>
// Revision:       $Id: TMrbLeCroy_4434.cxx,v 1.7 2008-12-04 14:53:12 Rudolf.Lutter Exp $       
// Date:           
//////////////////////////////////////////////////////////////////////////////
...
ClassImp(TMrbLeCroy_4434)

TMrbLeCroy_4434::TMrbLeCroy_4434(const Char_t * ModuleName, const Char_t * ModulePosition) :
										TMrbCamacModule(ModuleName, "LeCroy_4434", ModulePosition, 0, 32, 1 << 24) {
//__________________________________________________________________[C++ CTOR]
//////////////////////////////////////////////////////////////////////////////
// Name:           TMrbLeCroy_4434
// Purpose:        Create an ADC of type LeCroy 4434
// Arguments:      Char_t * ModuleName      -- name of camac module
//                 Char_t * ModulePosition  -- B.C.N for this module
// Results:        --
// Exceptions:
// Description:    Creates a camac module of type LeCroy 4434.
// Keywords:
//////////////////////////////////////////////////////////////////////////////
	...
	if (!this->IsZombie()) {
		if (gMrbConfig == NULL) {
			...
			SetTitle("LeCroy 4434 Scaler 32 ch a 24 bits"); 	// store module type
			mTypeBits = TMrbConfig::kModuleCamac | TMrbConfig::kModuleListMode | TMrbConfig::kModuleScaler;
...
Bool_t TMrbLeCroy_4434::MakeReadoutCode(ofstream & RdoStrm, TMrbConfig::EMrbModuleTag TagIndex) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           TMrbLeCroy_4434::MakeReadoutCode
...
// Exceptions:
// Description:    Writes code for readout of a lecroy 4434 module.
// Keywords:
//////////////////////////////////////////////////////////////////////////////
