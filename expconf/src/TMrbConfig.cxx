...
const SMrbNamedXShort kMrbLofAnalyzeTags[] =
							{
								...
								{TMrbConfig::kAnaSevtFillHistogramsHB,		"SEVT_FILL_HISTOGRAMS_HITBUFFER"			},
							...
							while (sevt = (TMrbSubevent *) sevtIter->Next()) {
								if (sevt->HistosToBeAllocated() && sevt->IsInArrayMode()) {
									...
									if (!list.good()) {
										...
										list	<< "### WARNING! List generated by Config.C - DO NOT EDIT, will be overwritten" << endl;
										list	<< "### Use method " << this->GetName()
												<< "->AddHistoToArray(\"" << sevt->GetName() << "\", \"<histoName>\");" << endl;
										list	<< "### to add your entries permanently" << endl;
										TIterator * paramIter = sevt->GetLofParams()->MakeIterator();
										while (param =  (TMrbModuleChannel *) paramIter->Next()) {
						...
						if (fLofHistoArrays.First()) {
							...
							while (hArray = (TMrbNamedX *) hIter->Next()) {
								...
								if (!list.good()) {
									...
									TString lName = hArray->GetTitle();
									lName = lName(0, lName.Index(".", 0));
									list	<< "### WARNING! List generated by Config.C - DO NOT EDIT, will be overwritten" << endl;
									list	<< "### Use method " << this->GetName()
											<< "->AddHistoToArray(\"" << lName << "\", \"<histoName>\");" << endl;
									list	<< "### to add your entries permanently" << endl;
									TObjArray * lofHistos = (TObjArray *) hArray->GetAssignedObject();
									TMrbNamedX * h;
