...
// Revision:       $Id: TMrbSilena_4418V.cxx,v 1.10 2008-12-10 12:13:50 Rudolf.Lutter Exp $       
// Date:           
//////////////////////////////////////////////////////////////////////////////
...
Bool_t TMrbSilena_4418V::CheckSubeventType(TMrbSubevent * Subevent) const {
...
//////////////////////////////////////////////////////////////////////////////
	...
	switch (TagIndex) {
		case TMrbConfig::kModuleInitChannel:
			...
			fCodeTemplates.Substitute("$lowerThresh", camacChannel->Get(TMrbSilena_4418V::kRegLowerThresh));
			fCodeTemplates.Substitute("$upperThresh", camacChannel->Get(TMrbSilena_4418V::kRegUpperThresh));
			fCodeTemplates.Substitute("$offset", camacChannel->Get(TMrbSilena_4418V::kRegOffset));
			fCodeTemplates.WriteCode(RdoStrm);
			break;
