...
// Revision:       $Id: TMrbCaen_V785.cxx,v 1.14 2006-11-21 10:07:35 Rudolf.Lutter Exp $       
// Date:           
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
	...
	switch (TagIndex) {
		case TMrbConfig::kModuleInitChannel:
			...
			fCodeTemplates.Substitute("$lowerThresh", chn->Get(TMrbCaen_V785::kRegThresh));
			fCodeTemplates.WriteCode(RdoStrm);
			break;
...
Bool_t TMrbCaen_V785::CheckSubeventType(TObject * Subevent) const {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
