...
// Revision:       $Id: TMrbSubevent_Caen_3.cxx,v 1.7 2004-09-28 13:47:33 rudi Exp $       
// Date:           
//////////////////////////////////////////////////////////////////////////////
...
#include "TMrbSubevent_Caen_3.h"

#include "SetColor.h"

extern TMrbConfig * gMrbConfig;

ClassImp(TMrbSubevent_Caen_3)

TMrbSubevent_Caen_3::TMrbSubevent_Caen_3(const Char_t * SevtName, const Char_t * SevtTitle, Int_t Crate)
...
//////////////////////////////////////////////////////////////////////////////
	...
	if (!this->IsZombie()) {
		if (*SevtTitle == '\0') SetTitle("CAMAC subevent [10,43]: CAEN data, multi-module, multi-event");
...
Bool_t TMrbSubevent_Caen_3::MakeReadoutCode(ofstream & RdoStrm,	TMrbConfig::EMrbReadoutTag TagIndex,
