...
// Revision:       $Id: TMrbSubevent_Caen_1.cxx,v 1.7 2004-09-28 13:47:33 rudi Exp $       
// Date:           
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
	...
	if (!this->IsZombie()) {
		if (*SevtTitle == '\0') SetTitle("CAMAC subevent [10,41]: CAEN data, multi-module, single-event (MAXEVENTS=1)");
