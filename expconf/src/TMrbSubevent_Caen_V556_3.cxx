...
//////////////////////////////////////////////////////////////////////////////
// Name:           expconf/src/TMrbSubevent_Caen_556_3.cxx
// Purpose:        MARaBOU configuration: subevents of type [10,35] - CAEN data
// Description:    Implements class methods to handle [10,35] subevents
//                 reflecting data structure of Caen V556 ADCs
// Keywords:
// Author:         R. Lutter
// Mailto:         <a href=mailto:rudi.lutter@physik.uni-muenchen.de>R. Lutter</a>
// Revision:       $Id: TMrbSubevent_Caen_V556_3.cxx,v 1.1 2009-10-07 08:49:31 Rudolf.Lutter Exp $
// Date:
//////////////////////////////////////////////////////////////////////////////
...
#include "TMrbSubevent_Caen_V556_3.h"

#include "SetColor.h"

extern TMrbConfig * gMrbConfig;

ClassImp(TMrbSubevent_Caen_V556_3)

TMrbSubevent_Caen_V556_3::TMrbSubevent_Caen_V556_3(const Char_t * SevtName, const Char_t * SevtTitle, Int_t Crate)
																: TMrbSubevent(SevtName, SevtTitle, Crate) {
//__________________________________________________________________[C++ CTOR]
//////////////////////////////////////////////////////////////////////////////
// Name:           TMrbSubevent_Caen_V556_3
// Purpose:        Create a subevent type [10,35]
// Arguments:      Char_t * SevtName       -- subevent name
//                 Char_t * SevtTitle      -- ... and title
//                 Int_t Crate             -- crate number
// Results:        --
// Exceptions:
// Description:    Create a new subevent of type [10,35]
...
Bool_t TMrbSubevent_Caen_V556_3::MakeReadoutCode(ofstream & RdoStrm,	TMrbConfig::EMrbReadoutTag TagIndex,
															TMrbTemplate & Template,
															const Char_t * Prefix) {
//________________________________________________________________[C++ METHOD]
//////////////////////////////////////////////////////////////////////////////
// Name:           TMrbSubevent_Caen_556_3::MakeReadoutCode
