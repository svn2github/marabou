...
class TUsrEvent : public TObject {
	...
	public:
		...
		Int_t FillSevtFromHB_TS(TUsrHBX * HBX, Int_t Hidx, Int_t DeltaTS, Bool_t FillHisto = kTRUE, Int_t Didx = TUsrHit::kHitEnergy);
		Bool_t FillEventFromHB(TArrayI & LofIndices, Bool_t FillHisto = kTRUE, Int_t Didx = TUsrHit::kHitEnergy, Int_t InitValue = 0);
		Bool_t FillEventFromHB_TS(TArrayI & LofIndices, Int_t DeltaTS, Bool_t FillHisto = kTRUE, Int_t Didx = TUsrHit::kHitEnergy, Int_t InitValue = 0);
		Bool_t FillEventFromHB_EB(TArrayI & LofIndices, Int_t DeltaTS, Bool_t FillHisto = kTRUE, Int_t Didx = TUsrHit::kHitEnergy, Int_t InitValue = 0);
