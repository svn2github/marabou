...
class TMrbCaen_V820 : public TMrbVMEScaler {
	...
	public:
		...
		virtual inline const Char_t * GetMnemonic() { return("caen_V820"); }; 	// module mnemonic

		inline void Help() { gSystem->Exec("kdehelp /usr/local/Marabou/doc/html/TMrbCaen_V820.html&"); };
